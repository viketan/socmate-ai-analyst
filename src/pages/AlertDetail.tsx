              ...
              {alert.Correlation.RelatedAlerts.length > 0 && (
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {alert.Correlation.RelatedAlerts.map((relatedId, index) => (
                      <Button
                        key={relatedId}
                        variant="outline"
                        size="sm"
                        className="font-mono text-primary hover:bg-primary/10 hover:border-primary/50 transition-all duration-200 group"
                      ...
                      >
                        ...
                        <ExternalLink className="h-3 w-3 ml-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
                      </Button>
                    ))}
                  </div>
                </div>
